...
class DashboardCoreModel {
    ...
    private $queries = array(
        ...
        "classesproperties" => "SELECT class, property, cnt_distinct_value, cnt, sumcount FROM gui.dash_classes_properties_func() ",
    ...
    public function __construct() {
        ...
        try {
            ...
            \Drupal::messenger()->addWarning($this->t('Error during the DashboardCore Model initialization!') . ' ' . $ex->getMessage());
            return array();
        }
    }
