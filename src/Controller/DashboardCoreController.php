...
class DashboardCoreController extends \Drupal\arche_core_gui\Controller\ArcheBaseController {
    ...
    public function dashboardDetailAjax(string $key = "properties"): array {
        return [
            ...
            '#attached' => [
                'library' => [
                    'arche_core_dashboard/detailajax-css-and-js',
                ]
            ]
        ];
    }
    ...
    public function dashboardDetailAjaxApi(string $key): Response {
        ...
        $response->setContent(
                json_encode(
                        array(
                            "aaData" => $data,
                            "iTotalRecords" => ($data[0]['sumcount']) ? (string)$data[0]['sumcount'] : "0",
                            "iTotalDisplayRecords" => ($data[0]['sumcount']) ? (string)$data[0]['sumcount'] : "0",
                            "draw" => intval($draw),
                            "cols" => $cols
                        )
                )
    ...
    public function getValuesByPropertyDetail(string $params): array {
        ...
        return [
            ...
            '#attached' => [
                'library' => [
                    'arche_core_dashboard/arche-ds-vbp-css-and-js',
                ]
            ]
        ];
    }
    ...
    public function getProperty(string $property) {
        ...
        return [
            ...
            '#attached' => [
                'library' => [
                    'arche_core_dashboard/arche-ds-property-css-and-js',
                ]
            ]
        ];
    }
